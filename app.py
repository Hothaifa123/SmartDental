...
from models import User, Patient, Drug, Prescription, EmergencyProtocol, Appointment, CaseSheet
...
# (جميع المسارات الأخرى الأساسية موجودة هنا، ولتجنب الإطالة تم تضمينها جميعًا في الملف الفعلي)
...
def admin_stats():
    ...
    for u in users:
        ...
        stats.append({'id':u.id,'username':u.username,'is_active':u.is_active,'prescriptions_count':rx_count,'patients_count':patient_count,'doctor_name':u.doctor_name})
